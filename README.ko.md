...
> **2026-04-21 정책 안내.** 2026년 4월 21일(미국 시간), Anthropic이 소비자 요금제 약관을 개정하면서 **Pro 티어의 Claude Code 접근 권한을 폐지**했습니다 — 이제 Claude Code는 Max 요금제 혹은 API로만 쓰실 수 있습니다. 어느 agentic CLI를 쓰시든 PAIDEIA가 그대로 동작할 수 있도록 범용성을 유지하고자, 같은 라이선스·같은 디스크 레이아웃을 유지한 채 플러그인을 OpenAI Codex CLI로도 이식했습니다. 두 에디션 모두 함께 관리되니, 구독 중이신 쪽을 고르시면 됩니다.
